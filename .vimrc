...
nnoremap <silent><Leader><S-F> :<C-u>cal CocAction('format')<CR>:w<CR>
...
nnoremap <silent><Leader>l :<C-u>w<CR>:e!<CR>:echo 'Reload Buffer'<CR>
nnoremap <silent><Leader><Leader>l :<C-u>w<CR>zz:CocRestart<CR>
